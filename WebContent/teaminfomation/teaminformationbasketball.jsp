...
<br />
 ...
 <c:forEach var="teamscorelist" items="${teamscorelist}" varStatus="var">
	...
	<td style="text-decoration: underline;"><a style="color: #5AAEFF;" href="/toto/teaminfomation/teamcontentbasket.to?teamname=${teamscorelist.home}&snum=${6}&league=KBL ">${teamscorelist.home}</a></td>
