...
<font  size="5"color="#FF7012">K클래식 순위 15시즌</font>
</td></tr>
</table>
<br />
 ...
 <c:forEach var="teamscorelist" items="${teamscorelist}" varStatus="var">
	...
	<td style="text-decoration: underline;"><a style="color: #5AAEFF;" href="/toto/teaminfomation/teamcontent.to?teamname=${teamscorelist.home}&snum=${6}&league=K리그">${teamscorelist.home}</a></td>
