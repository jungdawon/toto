...
**********************************************************************************************/
	...
	****************************************************************************/
	...
	agspay.setValue("Job", request.getParameter("Job"));				//금액
...
<form name=frmAGS_pay_ing method=post action=/toto/agspay/AGS_pay_result.to>
<input type=hidden name=UserId value="<%=agspay.getResult("UserId")%>">	<!-- 회원 ID -->
<input type=hidden name=Job value="<%=agspay.getResult("Job")%>">	<!-- 회원 ID -->
...
<input type=hidden name=rAmt value="<%=request.getParameter("Amt")%>">			<!-- 결제금액 -->
